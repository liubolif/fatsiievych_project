...
# def event_logo(id):
#     imgObj = Image.query.get_or_404(id)
#     return app.response_class(imgObj.image, mimetype='application/octet-stream')
#
#
# @app.route("/img", methods=['POST', 'GET'])
# def image():
#     imgObj = Image.query.get(1)
#     form = ImageForm()
#     if form.validate_on_submit():
#         files = request.files.getlist('picture')
#         if files:
#             imgObj.image = files[0].file.read()
#         return redirect(url_for('image'))
#
#     return render_template('image.html', title='image', imgObj=imgObj)
